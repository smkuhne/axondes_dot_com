            ...
            <div>
                    ...
                    <Container>
                        <Carousel interval={null} prevIcon={<span aria-hidden="true" className="carousel-icon">&#60;</span>} nextIcon={<span aria-hidden="true" className="carousel-icon">&#62;</span>} indicators={true}>
                            <Carousel.Item>
                                ...
                                <Carousel.Caption>
                                    <h2 class="text-center"> Basic Needs and Services Referendum </h2>
                                    <p className="spacer">
                            ...
                            <Carousel.Item>
                                ...
                                <Carousel.Caption>
                                    <h2 class="text-center"> Unitrans Winter Referendum </h2>
                                    <p className="spacer">
                            ...
                            <Carousel.Item>
                                ...
                                <Carousel.Caption>
                                    <h2 class="text-center"> ASUCD Redefined </h2>
                                    <p className="spacer">
                            ...
                            <Carousel.Item>
                                ...
                                <Carousel.Caption>
                                    <h2 class="text-center"> ASUCD Rebrand </h2>
                                    <p className="spacer">
                ...
                <section>
                    ...
                    <Container className="spacer">
                        <Row>
                            <Col md={6}>
                                Aggie Studios is a unit of ASUCD (The Associated Students of the University of California Davis). We are the video production unit that
                            ...
                            <Col md={6}>
                                ...
                                high priority projects for clients. As senior animator, I also take on a leadership position by providing lots of input on the direction videos
